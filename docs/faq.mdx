...
**Default errors** (exit code 1): hardcoded text, missing keys, replica-lag, untranslated values, type mismatches.

**Default warnings** (exit code 0): orphan keys, unused keys, unresolved keys.
